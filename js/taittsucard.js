...
[rate[2],rate[2],rate[1],rate[0],rate[0],rate[0],rate[0],rate[0],rate[3],rate[2],rate[2],rate[1],rate[3],rate[3],rate[3],rate[3]],
...
[rate[1],rate[0],rate[1],rate[1],rate[1],rate[0],rate[1],rate[0],rate[2],rate[3],rate[3],rate[2],rate[0],rate[1],rate[1],rate[0]],
[rate[0],rate[0],rate[1],rate[3],rate[3],rate[3],rate[3],rate[3],rate[3],rate[3],rate[3],rate[3],rate[3],rate[2],rate[3],rate[0]],
[rate[2],rate[2],rate[3],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[1],rate[1],rate[1],rate[1]],
[rate[1],rate[1],rate[1],rate[2],rate[0],rate[1],rate[1],rate[3],rate[1],rate[1],rate[1],rate[1],rate[1],rate[1],rate[1],rate[2]],
[rate[0],rate[0],rate[1],rate[3],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[0],rate[3],rate[3],rate[2],rate[0]],
[rate[0],rate[1],rate[0],rate[0],rate[3],rate[2],rate[2],rate[2],rate[2],rate[1],rate[2],rate[3],rate[1],rate[1],rate[0],rate[2]],
